...
`;
    ...
    if (only1InputFormElement) {
      ...
      duplicateNode.querySelectorAll("input").forEach((_input) => {
        ...
        spanInputLabelNode.innerText = `Input ${type}: ${label} `;
        spanInputLabelNode.style.marginLeft = "4px";
        spanInputLabelNode.style.marginRight = "10px";
        img.parentNode.appendChild(spanInputLabelNode, img);
      });
